...
export default function AboutPage() {
  ...
  return (
    <div id="about" className="min-h-screen bg-[#f3f8e7] py-16">
        ...
        <motion.div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-[#2b7a0b]/10 rounded-3xl"></div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="w-full lg:w-1/2"
          >
            <h1 className="text-4xl lg:text-5xl font-bold text-[#2b7a0b] mb-8">
              TENTANG KAMI
            </h1>
